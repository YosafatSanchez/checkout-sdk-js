...
describe('AdyenV2PaymentStrategy', () => {
    ...
    describe('#Initializes & Executes', () => {
        ...
        beforeEach(() => {
            ...
            let handleOnSubmit: (componentState: AdyenComponentState) => {};
            ...
            paymentComponent = {
                mount: jest.fn(() => {
                    ...
                    handleOnSubmit(getComponentState());
            ...
            jest.spyOn(adyenCheckout, 'create')
                .mockImplementationOnce(jest.fn((_method, options) => {
                    const { onChange, onSubmit } = options;
        ...
        describe('#initialize()', () => {
            ...
            it('Initializes WechatpayQR payment method', async () => {
                jest.spyOn(store.getState().paymentMethods, 'getPaymentMethod').mockReturnValue(getAdyenV2(AdyenPaymentMethodType.WechatpayQR));
